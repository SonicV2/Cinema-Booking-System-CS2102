...
<table>
	<tr>
		<td>
			<form action="BookingList2.php" method="GET">
				<input type="hidden" name="user" value="<?=$_SESSION['user']?>">
				<input type="submit" value="View Tickets Booked by Selected Customer">
			</form>
		</td>
		<td>
			<form action="AdminSelectCustomer.php">
				<input type="submit" value="Select Another Customer">
			</form>
		</td>
	</tr>
</table>
